                ...
                >
                    ...
                    >
                        <div className='flex items-center gap-2.5 min-w-0'>
                            ...
                            <div className='min-w-0'>
                                ...
                                <div
                                    className={`text-[10px] truncate font-medium ${isDark ? 'text-zinc-400' : 'text-orange-100/80'}`}
                                >
                    ...
                    <div className='flex items-center justify-between pt-2 px-0.5'>
                        <div className='flex items-center gap-1.5 min-w-0'>
                            ...
                            />
                            <span
                                className={`text-[11px] font-medium truncate ${isDark ? 'text-zinc-400' : 'text-orange-100/90'}`}
                            >
                                {!gasUrl
                                    ? 'Chưa kết nối'
                                    : syncStatus === 'syncing'
