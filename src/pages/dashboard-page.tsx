      ...
      <div className='grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4'>
        ...
        >
          ...
          <div className='flex items-center justify-between'>
            <span className='text-[10px] sm:text-[11px] font-bold uppercase tracking-wider opacity-60'>Doanh thu</span>
        ...
        >
          ...
          <div className='flex items-center justify-between'>
            <span className='text-[10px] sm:text-[11px] font-bold uppercase tracking-wider opacity-60'>Tổng đơn</span>
        ...
        >
          ...
          <div className='flex items-center justify-between'>
            <span className='text-[10px] sm:text-[11px] font-bold uppercase tracking-wider opacity-60'>Chờ in</span>
        ...
        >
          ...
          <div className='flex items-center justify-between'>
            <span className='text-[10px] sm:text-[11px] font-bold uppercase tracking-wider opacity-60'>Đang in</span>
