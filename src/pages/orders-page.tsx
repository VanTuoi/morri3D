                    ...
                    <div className='flex items-center gap-2 flex-wrap'>
                        ...
                        {statusCounts[STATUSES.PENDING] > 0 && (
                            <button
                                type='button'
                                onClick={() =>
                                    setStatusFilter((prev) => (prev === STATUSES.PENDING ? 'ALL' : STATUSES.PENDING))
                                }
                        ...
                        {statusCounts[STATUSES.PRINTING] > 0 && (
                            <button
                                type='button'
                                onClick={() =>
                                    setStatusFilter((prev) => (prev === STATUSES.PRINTING ? 'ALL' : STATUSES.PRINTING))
                                }
                                className={`text-xs px-2.5 py-0.5 rounded-full font-bold border flex items-center gap-1 transition-all cursor-pointer ${
                            ...
                            >
                                <Printer
                                    size={12}
                                    className={statusFilter === STATUSES.PRINTING ? 'animate-bounce' : ''}
                                />
                                            ...
                                            <span
                                                className={`text-[9px] px-1.5 py-0.2 rounded-full font-mono ${
                                                    isActive
                                                        ...
                                                        : 'opacity-70 bg-black/5 dark:bg-white/10'
                                                }`}
                                            >
                                                {f.count}
                                            </span>
                                            ...
                                            return (
                                                ...
                                                >
                                                    {hex ? (
                                                        ...
                                                        <Layers
                                                            size={10}
                                                            className='text-orange-400 opacity-80 flex-shrink-0'
                                                        />
                                                    )}
                                                    <span>{m.type}</span>
